...
**Steps**: each Event can define a list of Steps to be executed when the event is triggered. *hopeit.engine* ensures execution of steps and dependency based on its inputs/outputs, allowing each step to be simple and independently testable.
