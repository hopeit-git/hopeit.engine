...
# data/dataframes
export PYTHONPATH=engine/src/:plugins/data/dataframes/src/:plugins/data/dataframes/test/integration/ && python3 -m pytest -v --cov-fail-under=80 --cov-report=term --cov=plugins/data/dataframes/src/ plugins/data/dataframes/test/integration/
code+=$?
fi
