...
__api__ = event_api(
    ...
    responses={
        ...
        401: (
            ...
            "Login failed, invalid credentials. An http-cookie is expected",
        ),
    },
)
...
async def __postprocess__(
    payload: AuthInfoExtended, context: EventContext, *, response: PostprocessHook
) -> AuthInfo:
