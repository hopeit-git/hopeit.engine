...
def test_generate_mode(
    mock_api_app_config, mock_api_spec, mock_plugin_config, mock_app_api_generated
):
    api.clear()
    _init_api(
        mock_api_app_config,
...
def test_load_api_file(mock_api_spec):
    api.clear()
...
def test_save_api_file(mock_api_spec):
    api.clear()
    file_name = f"/tmp/{str(uuid.uuid4())}.json"
...
def test_register_server_config(mock_api_app_config, mock_api_spec):
...
def test_register_apps(mock_api_app_config, mock_api_spec, mock_plugin_config):
    _init_api(
        mock_api_app_config,
        mock_api_spec,
        plugin=mock_plugin_config,
...
async def test_enable_swagger(mock_api_app_config, mock_api_spec, mock_plugin_config):
    _init_api(
        mock_api_app_config,
        mock_api_spec,
        plugin=mock_plugin_config,
...
async def test_enable_swagger_incompatible_api(
    mock_api_app_config, mock_api_spec, mock_plugin_config
):
    _init_api(
        mock_api_app_config,
        mock_api_spec,
...
def test_add_route_auto_name(mock_api_app_config, mock_api_spec, mock_plugin_config):
    _init_api(
        mock_api_app_config,
        mock_api_spec,
        plugin=mock_plugin_config,
...
def test_add_route_override_name(mock_api_app_config, mock_api_spec, mock_plugin_config):
    _init_api(
        mock_api_app_config,
        mock_api_spec,
        plugin=mock_plugin_config,
...
def test_api_disabled(mock_api_app_config):
    api.clear()
...
async def test_remove_metadata(mock_api_app_config, mock_api_spec, mock_plugin_config):
    _init_api(
        mock_api_app_config,
        mock_api_spec,
        plugin=mock_plugin_config,
