...
__all__ = ["ErrorInfo", "format_exc", "json_exc"]
...
class ErrorInfo:
    ...
    def from_exception(e: BaseException):
        return ErrorInfo(msg=str(e), tb=traceback.format_exception_only(type(e), e))
...
def json_exc(e: Exception) -> str:
    return urllib.parse.quote(json.dumps(format_exc(e)))
